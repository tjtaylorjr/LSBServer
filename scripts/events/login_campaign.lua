...
local loginCampaignYear = 2024-- 2021
local loginCampaignMonth = 9 -- 8
local loginCampaignDay = 1 -- 25
local loginCampaignDuration = 30 -- 23 -- Duration is set in Earth days (Average is 23 days)

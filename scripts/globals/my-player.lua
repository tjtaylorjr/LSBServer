...
local startingJobGear =
{
    ...
    [xi.job.MNK] = { xi.item.WHITE_BELT,   xi.item.DESTRIER_BERET,     xi.item.CHOCOBO_SHIRT                            },
    [xi.job.WHM] = { xi.item.ONION_ROD,    xi.item.SCROLL_OF_CURE_EX,  xi.item.DESTRIER_BERET,    xi.item.CHOCOBO_SHIRT },
    [xi.job.BLM] = { xi.item.ONION_STAFF,  xi.item.SCROLL_OF_STONE_EX, xi.item.DESTRIER_BERET,    xi.item.CHOCOBO_SHIRT },
    [xi.job.RDM] = { xi.item.ONION_DAGGER, xi.item.SCROLL_OF_DIA_EX,   xi.item.DESTRIER_BERET,    xi.item.CHOCOBO_SHIRT },
    [xi.job.THF] = { xi.item.ONION_KNIFE,  xi.item.DESTRIER_BERET,     xi.item.CHOCOBO_SHIRT                            },
}
